...
class Habit(models.Model):
    ...
    periodity = models.CharField(max_length=50, choices=[('daily', 'Ежедневно'), ('weekly', 'Еженедельно'), ('monthly', 'Ежемесячно')])
    ...
    linked_habit = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True)
